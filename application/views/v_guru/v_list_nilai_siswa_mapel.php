...
<div class="content-wrapper">
                                ...
                                <table id="example1" class="table table-striped">
                                 ...
                                 <tbody>
                                  ...
                                  foreach ($siswa as $peserta) :
                                    ...
                                    if($cek > 0){
                                      $aksi = '<a href="'.base_url('guru_mapel/nilai/update_nilai').'?nisn='.$peserta['nisn'].'&id_semester='.$_GET['semester'].'&id_mapel='.$_GET['mapel'].'" class="btn btn-sm btn-success update">Perbarui Nilai</a>';
                                    }else{
                                      $aksi = '<a href="'.base_url('guru_mapel/nilai/input_nilai').'?nisn='.$peserta['nisn'].'&id_semester='.$_GET['semester'].'&id_mapel='.$_GET['mapel'].'" class="btn btn-sm btn-primary update">Input Nilai</a>';
                                    }
                                  ?>
                                    <tr>
                                      <td><?=$no++?></td>
  ...
  <script>
      ...
      $('#mapel').on('change', function(){
        ...
        $.ajax({
           method : "POST",
            url : "<?=base_url('guru_mapel/nilai/get_kelas')?>",
