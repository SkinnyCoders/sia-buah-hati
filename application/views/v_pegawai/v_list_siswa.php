                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <!-- <a href="<?= base_url('pegawai/siswa/terima/') ?>" target="_blank" id="" class="btn btn-sm btn-success mr-1 update"><i class="fa fa-check"></i></a>
                      <a href="<?= base_url('pegawai/siswa/tolak/') ?>" target="_blank" id="" class="btn btn-sm btn-danger update"><i class="fa fa-times"></i></a> -->
                      </td>
                    </tr>
                  <?php
                  endforeach; 
