                            ...
                            <table id="example1" class="table table-striped">
                             ...
                             ?>
                              <tr>
                                ...
                                <td><a href="javascript:void(0)" data-toggle="modal" id="<?=$l['id_mapel']?>" data-target="#modal-update" class="btn btn-sm btn-primary mr-3 update"><i class="fa fa-edit"></i></a><a href="javascript:void(0)" id="<?=$l['id_mapel']?>" class="btn btn-sm btn-danger delete"><i class="fa fa-trash"></i></a></td>
                              </tr>
                             <?php endforeach;?>
                             </tbody>
                           </table>
             ...
             <div class="modal fade" id="modal-update">
               <div class="modal-dialog">
                 <div class="modal-content">
                   ...
                   <div class="modal-body">
                         <!-- form start -->
                      <form action="<?= base_url('tatausaha/mapel/update_mapel_kelas') ?>" method="post" role="form">
                        <input type="hidden" name="id_mapel" id="kode_mapel_update" value="">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
  ...
  <script>
   ...
   $('.update').on('click', function() {
     ...
     $.ajax({
       type: "post",
       url: "<?= base_url('tatausaha/mapel/update_mapel_kelas') ?>",
       data: {
     ...
     Swal.fire({
       ...
       function(isConfirm) {
         if (isConfirm.value) {
           $.ajax({
             type: "post",
             url: "<?= base_url() ?>tatausaha/mapel/delete_konfigurasi/" + dataId,
             data: {
               'id_kelas': dataId
             },
             success: function(respone) {
               window.location.href = "<?= base_url('tatausaha/mapel/mapel_kelas') ?>";
             },
