                        ...
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <form action="" method="POST">
                                <div class="form-group mb-3">
                                    <input id="inputEmail" type="username" placeholder="username atau nisn" name="username" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                                </div>
